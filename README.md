...
$$
\text{Penalty}_{\%} = \begin{cases} 0 & \lvert\theta_{pitch}\rvert \leq 0.5^{\circ} \\[6pt] \min\bigl(2.5 \cdot (\lvert\theta_{pitch}\rvert - 0.5),\; 5.0\bigr) & \lvert\theta_{pitch}\rvert > 0.5^{\circ} \end{cases}
$$
